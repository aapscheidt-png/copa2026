...
function renderStats(){
  ...
  return`<div class="stats-version">✓ V16 GitHubPages Auto · ESPN automático · cartões sem pontos</div>
<div class="kpi-grid">
...
<table class="info-tbl">
  ...
  <tr><td>Versão</td><td style="color:var(--gold)">V16 GitHubPages Auto</td></tr>
</table></div>`;
}
...
function renderBrasil(){
  ...
  return `<div class="pro-badge">✓ V16 GitHubPages Auto · base única carregada</div>
  <div class="team-hero">
...
console.log('Copa 2026 V16 GitHubPages Auto carregado');
