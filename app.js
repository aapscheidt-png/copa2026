...
function renderStats(){
  ...
  // Artilheiros - V23 Mata-Mata Automático
  ...
  return`<div class="stats-version">✓ V23 Mata-Mata Automático · gols, cartões e estatísticas restaurados</div>
<div class="kpi-grid">
...
<table class="info-tbl">
  ...
  <tr><td>Versão</td><td style="color:var(--gold)">V23 Mata-Mata Automático</td></tr>
</table></div>`;
}
...
function renderBrasil(){
  ...
  return `<div class="pro-badge">✓ V23 Mata-Mata Automático · base única carregada</div>
  <div class="team-hero">
...
console.log('Copa 2026 V23 Mata-Mata Automático carregado');
