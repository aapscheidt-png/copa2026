...
function renderStats(){
  ...
  // Artilheiros - V24 Cartões Hotfix
  ...
  return`<div class="stats-version">✓ V24 Cartões Hotfix · cartões por eventos + totais ESPN</div>
<div class="kpi-grid">
...
<table class="info-tbl">
  ...
  <tr><td>Versão</td><td style="color:var(--gold)">V24 Cartões Hotfix</td></tr>
</table></div>`;
}
...
function renderBrasil(){
  ...
  return `<div class="pro-badge">✓ V24 Cartões Hotfix · base única carregada</div>
  <div class="team-hero">
...
console.log('Copa 2026 V24 Cartões Hotfix carregado');
